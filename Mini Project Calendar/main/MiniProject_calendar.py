...
def newWindowAlarm():
    ...
    newWindowAlarm.config(bg='#6D9BF1')
    ...
    def alarm():
        ...
        while True:
            ...
            if current_time == set_alarm_time:
                ...
                messagebox.showinfo("Alarm", "Time Up")
                ...
                alarm_status = Label(
                    newWindowAlarm, text='Alarm Has Ended', bg='#6D9BF1')
...
############################ alarm labels ###############################
    alarm_hour_list = ['01', '02', '03', '04', '05', '06', '07',
                       '08', '09', '10', '11', '12']
...
############################ reminder labels ###############################
    ...
    options.config(bg="light blue", width=30, height=1)
